              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="card card-style my-2">
                  ...
                  <div className="card-body">
                    ...
                    >
                     Nabeel Naveed Ghouri
                    </h5>
                    <p className="card-text">
                      bscs 8th semester student from ucp grw.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="row row1">
            ...
            <div className="col-sm style1">
              ...
              <p className="paragraphs1">
                  ...
                  to buy products from here. They gives us best price,best discount and we make our own price with just a click" - Usama Bhatti
              </p>
              <p className="paragraphs1">
